...
export const FANFOU_OAUTH_AUTHORIZE = 'FANFOU_OAUTH_AUTHORIZE'
export const FANFOU_OAUTH_GET_STATUS = 'FANFOU_OAUTH_GET_STATUS'
export const FANFOU_OAUTH_CLEAR_TOKENS = 'FANFOU_OAUTH_CLEAR_TOKENS'
export const FANFOU_OAUTH_API_REQUEST = 'FANFOU_OAUTH_API_REQUEST'

export const PERSONAL_ARCHIVE_DOWNLOAD_IMAGES = 'PERSONAL_ARCHIVE_DOWNLOAD_IMAGES'
